...
0000000000400f11 <phase_3>:
  ...
  400f2d:	be 47 25 40 00       	mov    $0x402547,%esi
  ...
  400f4a:	ff 24 c5 c0 23 40 00 	jmpq   *0x4023c0(,%rax,8)
  400f51:	b8 75 01 00 00       	mov    $0x175,%eax
  400f56:	eb 3b                	jmp    400f93 <phase_3+0x82>
  400f58:	b8 87 03 00 00       	mov    $0x387,%eax
  400f5d:	eb 34                	jmp    400f93 <phase_3+0x82>
  400f5f:	b8 ea 02 00 00       	mov    $0x2ea,%eax
  400f64:	eb 2d                	jmp    400f93 <phase_3+0x82>
  400f66:	b8 82 03 00 00       	mov    $0x382,%eax
  400f6b:	eb 26                	jmp    400f93 <phase_3+0x82>
  400f6d:	b8 52 01 00 00       	mov    $0x152,%eax
  400f72:	eb 1f                	jmp    400f93 <phase_3+0x82>
  400f74:	b8 dc 00 00 00       	mov    $0xdc,%eax
  400f79:	eb 18                	jmp    400f93 <phase_3+0x82>
  400f7b:	b8 dd 01 00 00       	mov    $0x1dd,%eax
  ...
  400f8e:	b8 37 01 00 00       	mov    $0x137,%eax
...
0000000000400ff3 <phase_4>:
  ...
  40100f:	be 47 25 40 00       	mov    $0x402547,%esi
...
0000000000401060 <phase_5>:
  ...
  401093:	0f b6 92 00 24 40 00 	movzbl 0x402400(%rdx),%edx
  ...
  4010ac:	be aa 23 40 00       	mov    $0x4023aa,%esi
...
0000000000401276 <sig_handler>:
  ...
  4012b8:	bf 02 25 40 00       	mov    $0x402502,%edi
...
00000000004012cc <invalid_phase>:
  ...
  4012d3:	be 0a 25 40 00       	mov    $0x40250a,%esi
...
000000000040140e <explode_bomb>:
  ...
  401412:	bf 1b 25 40 00       	mov    $0x40251b,%edi
  401417:	e8 c4 f6 ff ff       	callq  400ae0 <puts@plt>
  40141c:	bf 24 25 40 00       	mov    $0x402524,%edi
...
0000000000401430 <read_six_numbers>:
  ...
  40144d:	be 3b 25 40 00       	mov    $0x40253b,%esi
...
000000000040146f <read_line>:
  ...
  4014dc:	bf 4d 25 40 00       	mov    $0x40254d,%edi
  ...
  401525:	bf 76 25 40 00       	mov    $0x402576,%edi
...
0000000000401595 <phase_defused>:
  ...
  4015c1:	be 91 25 40 00       	mov    $0x402591,%esi
  ...
  4015d5:	be 9a 25 40 00       	mov    $0x40259a,%esi
  ...
  4015e8:	bf 70 24 40 00       	mov    $0x402470,%edi
  4015ed:	e8 ee f4 ff ff       	callq  400ae0 <puts@plt>
  4015f2:	bf 98 24 40 00       	mov    $0x402498,%edi
  ...
  401606:	bf d0 24 40 00       	mov    $0x4024d0,%edi
...
000000000040162a <sigalrm_handler>:
  ...
  401633:	ba 48 29 40 00       	mov    $0x402948,%edx
...
000000000040174a <submitr>:
  ...
  401a95:	b9 20 2a 40 00       	mov    $0x402a20,%ecx
  ...
  401c36:	00 
  401c37:	be 27 2a 40 00       	mov    $0x402a27,%esi
  ...
  401c67:	00 
  401c68:	b9 70 29 40 00       	mov    $0x402970,%ecx
  ...
  401ee8:	b9 a0 29 40 00       	mov    $0x4029a0,%ecx
...
0000000000401f7b <init_driver>:
  ...
  40202a:	bf 41 26 40 00       	mov    $0x402641,%edi
  ...
  4020ec:	41 b8 41 26 40 00    	mov    $0x402641,%r8d
  4020f2:	b9 f8 29 40 00       	mov    $0x4029f8,%ecx
...
0000000000402150 <driver_post>:
  ...
  402158:	be 38 2a 40 00       	mov    $0x402a38,%esi
  ...
  402188:	52                   	push   %rdx
  402189:	41 b9 4f 2a 40 00    	mov    $0x402a4f,%r9d
  40218f:	49 89 f0             	mov    %rsi,%r8
  402192:	48 89 f9             	mov    %rdi,%rcx
  402195:	ba 57 2a 40 00       	mov    $0x402a57,%edx
  40219a:	be 6e 3b 00 00       	mov    $0x3b6e,%esi
  40219f:	bf 41 26 40 00       	mov    $0x402641,%edi
