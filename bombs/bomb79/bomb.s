...
0000000000400f11 <phase_3>:
  ...
  400f2d:	be 6f 25 40 00       	mov    $0x40256f,%esi
...
000000000040101c <phase_4>:
  ...
  401038:	be 6f 25 40 00       	mov    $0x40256f,%esi
...
0000000000401089 <phase_5>:
  ...
  4010bc:	0f b6 92 50 24 40 00 	movzbl 0x402450(%rdx),%edx
  ...
  4010d5:	be 06 24 40 00       	mov    $0x402406,%esi
...
000000000040124e <secret_phase>:
  ...
  40128e:	bf e0 23 40 00       	mov    $0x4023e0,%edi
...
000000000040129f <sig_handler>:
  ...
  4012e1:	bf 2a 25 40 00       	mov    $0x40252a,%edi
...
00000000004012f5 <invalid_phase>:
  ...
  4012fc:	be 32 25 40 00       	mov    $0x402532,%esi
...
0000000000401437 <explode_bomb>:
  ...
  40143b:	bf 43 25 40 00       	mov    $0x402543,%edi
  401440:	e8 9b f6 ff ff       	callq  400ae0 <puts@plt>
  401445:	bf 4c 25 40 00       	mov    $0x40254c,%edi
...
0000000000401459 <read_six_numbers>:
  ...
  401476:	be 63 25 40 00       	mov    $0x402563,%esi
...
0000000000401498 <read_line>:
  ...
  401505:	bf 75 25 40 00       	mov    $0x402575,%edi
  ...
  40154e:	bf 9e 25 40 00       	mov    $0x40259e,%edi
...
00000000004015be <phase_defused>:
  ...
  40162f:	bf f8 24 40 00       	mov    $0x4024f8,%edi
...
0000000000401653 <sigalrm_handler>:
  ...
  40165c:	ba 70 29 40 00       	mov    $0x402970,%edx
...
0000000000401773 <submitr>:
  ...
  401abe:	b9 48 2a 40 00       	mov    $0x402a48,%ecx
  ...
  401c5f:	00 
  401c60:	be 4f 2a 40 00       	mov    $0x402a4f,%esi
  ...
  401c90:	00 
  401c91:	b9 98 29 40 00       	mov    $0x402998,%ecx
  ...
  401f11:	b9 c8 29 40 00       	mov    $0x4029c8,%ecx
...
0000000000401fa4 <init_driver>:
  ...
  402053:	bf 69 26 40 00       	mov    $0x402669,%edi
  ...
  402115:	41 b8 69 26 40 00    	mov    $0x402669,%r8d
  40211b:	b9 20 2a 40 00       	mov    $0x402a20,%ecx
...
0000000000402179 <driver_post>:
  ...
  402181:	be 60 2a 40 00       	mov    $0x402a60,%esi
  ...
  4021b1:	52                   	push   %rdx
  4021b2:	41 b9 77 2a 40 00    	mov    $0x402a77,%r9d
  4021b8:	49 89 f0             	mov    %rsi,%r8
  4021bb:	48 89 f9             	mov    %rdi,%rcx
  4021be:	ba 7f 2a 40 00       	mov    $0x402a7f,%edx
  4021c3:	be 6e 3b 00 00       	mov    $0x3b6e,%esi
  4021c8:	bf 69 26 40 00       	mov    $0x402669,%edi
